...
class GenerationRun(Base):
    ...
    # A server-issued anonymous workspace identifier.  This is deliberately not
    # an email/account system: it keeps the free-tier portfolio deployment
    # simple while ensuring a caller cannot enumerate another workspace's runs.
    owner_id: Mapped[str] = mapped_column(String(36), nullable=False, index=True, default="local")
    ...
    excel_data: Mapped[bytes | None] = mapped_column(LargeBinary)
